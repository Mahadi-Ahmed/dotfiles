alias f='open -a Finder ./' #open current directory with finder
...
# alias glg='git log -n 40 --graph --oneline --decorate'
alias glg='git log -n 40 --graph --decorate'
alias moveSc='/Users/mahadiahmed/Code/mahadia/Util-Scripts/screenshot_mover/screenshotMover.py'
alias lg='lazygit'
